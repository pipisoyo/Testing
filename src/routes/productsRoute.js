 ...
 * @function
 */
productsRouter.post("/", authUser(['admin','premium']) , productController.addProduct);
 ...
 * @function
 */
productsRouter.delete("/:_id", authUser(['admin','premium']), productController.deleteProduct );
